...
def recommend_cars(title, cosine_sim, df, no_ofRecommendations=5):
    ...
    final_recommended_cars = result_df[['Car', 'Style', 'VehicleType', 'PriceRange', 'Transmission', 'similarity_score', 'Rating(outof10)']]
    return final_recommended_cars.head(no_ofRecommendations)

RESULT_TEMP = """
<div style="width:90%;height:100%;margin:1px;padding:5px;position:relative;border-radius:5px;border-bottom-right-radius: 60px;
box-shadow:0 0 5px 5px #ccc; background-color: #CCE8FA;
  border-left: 5px solid #98D2F7;">
<h4>{}</h4>
<p style="color:black;"><span style="color:black;">CAR STYLE: </span>{}</p>
<p style="color:black;"><span style="color:black;">VEHICLE TYPE: </span>{}</p>
<p style="color:black;"><span style="color:black;">PRICE RANGE: </span>{}</p>
<p style="color:black;"><span style="color:black;">TRANSMISSION TYPE: </span>{}</p>
<p style="color:black;"><span style="color:black;">SIMILARITY SCORE: </span>{}</p>
<p style="color:black;"><span style="color:black;">RATINGS: </span>{}</p>
</div>
"""
                ...
                try:
                    ...
                    with st.expander("VIEW RECOMMENDATIONS"):
                        ...
                        for row in results.iterrows():
                            ...
                            st.write(rec_car)
                            stc.html(RESULT_TEMP.format(rec_car, rec_style, rec_vehicleType, rec_price, rec_transmission, rec_score, rec_rating), height=350)
